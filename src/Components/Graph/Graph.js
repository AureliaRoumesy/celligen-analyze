...
function Graph(props) {
  ...
  useEffect(() => {
    ...
    const manipSelectedId = params.id;
    ...
    setHeaderToken(() => {
      axios.get(`${conf.url}/graph/${manipSelectedId}`)
        ...
        .catch(() => {
          message.error('Problème lors de la récupération des données, merci de rafraichir la page.', 3);
        });
    });
  ...
  const validateTimeStartEnd = () => {
    ...
    let arrayTemp = [...data];
    const indexStart = _.findIndex(data, foo => { return foo.hour === parseInt(initTime) });
    const indexEnd = _.findIndex(data, foo => { return foo.hour === parseInt(endTime) });
    ...
    <div>
      ...
      <div className='row'>
        ...
        <div className='col s6' style={{ display: 'inline-block' }} >
          ...
          <table style={{ width: '80%' }} className='centered'>
            <thead>
              <tr>
                <th>Nom</th>
        ...
        <table style={{ width: '90vw' }} className='centered'>
          ...
          <tbody>
            ...
            {axes && axes.map((axe, index) => (
              <tr key={index}>
                <td>{axe.name}</td>
                <td><div onClick={() => checkAxeFunction(index, [DO, setDO])}>{DO.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [N2Flo3, setN2Flo3])}>{N2Flo3.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [OvlAir, setOvlAir])}>{OvlAir.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [OvlO2, setOvlO2])}>{OvlO2.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [OvlN2, setOvlN2])}>{OvlN2.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [AirFlo1, setAirFlo1])}>{AirFlo1.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [O2Flo2, setO2Flo2])}>{O2Flo2.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [Agit, setAgit])}>{Agit.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [OvlFlo, setOvlFlo])}>{OvlFlo.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [CO2Flo4, setCO2Flo4])}>{CO2Flo4.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [OvlCO2, setOvlCO2])}>{OvlCO2.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [Temp, setTemp])}>{Temp.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [phOpt, setphOpt])}>{phOpt.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [DensiteCellMortes, setDensiteCellMortes])}>{DensiteCellMortes.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [DensiteCellVivantes, setDensiteCellVivantes])}>{DensiteCellVivantes.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [Glucose, setGlucose])}>{Glucose.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
                <td><div onClick={() => checkAxeFunction(index, [RdtProd, setRdtProd])}>{RdtProd.axe === index ? <i className='material-icons'>done</i> : <i className='material-icons'>crop_square</i>}</div></td>
              </tr>
            ))}
          </tbody>
        </table>
